defmodule Balsam.DagOrchestrator do
  use GenServer
  require Logger
  alias Balsam.{Orchestrator, JobStorage, Repo}
  alias Balsam.Schema.{DagDefinition, DagNode, DagRun}
  import Ecto.Query
  ...
  def init(opts) do
    ...
    state = %__MODULE__{
      dags: %{},
      running_dag_runs: %{},
      orchestrator_pid: Keyword.get(opts, :orchestrator_pid, Balsam.Orchestrator),
      schedule_timer: nil,
